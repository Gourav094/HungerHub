...
const Cart = () => {
    ...
    return (cartItems.length === 0) ? (
        <div className="flex flex-col justify-center items-center text-gray-700 ">
            ...
            <p className="mt-2 mb-5 text-center">You can go to home page to view more restaurants</p>
        ...
        <div className="bg-gray-100 h-fit">
            <div className="py-10 text-center">
                <h1 className="pb-4 font-semibold text-xl tracking-wider border">Free Shipping on order above Rs99</h1>
            </div>
            <div className="max-w-[1100px] my-0 mx-auto md:flex gap-10">
                <div className="bg-white md:w-3/5 min-h-[60vh] shadow py-4 px-6">
                    <ItemList items = {cartItems}/>
                    <button className="border mt-2 md:ml-64 bg-orange-400 py-1 px-2 rounded text-white" onClick={handleClearCart}>Clear Cart</button>
                </div>    
                <div className="bg-white md:w-1/3 h-fit shadow py-4 px-8 text-gray-600">
